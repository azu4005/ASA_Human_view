...
public class NewAnchorFeedbackScript : MonoBehaviour
{
    [SerializeField]
    [Tooltip("Reference to the Text Mesh Pro component on this object.")]
    private TextMeshPro feedbackText = default;

    private NewAnchorModuleScript anchorModuleScript;

    void Awake()
    {
        anchorModuleScript = GameObject.FindObjectOfType<NewAnchorModuleScript>();
