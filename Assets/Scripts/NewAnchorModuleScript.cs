...
public class NewAnchorModuleScript : MonoBehaviour
{
    [SerializeField]
    ...
    public string currentAzureAnchorID = "47eebe0e-e800-443c-b35d-672a652d48f7";
    //public string currentAzureAnchorID = "b3739d2d-a632-40e2-a882-f1844e2b73da";
    ...
    public async void StartAzureSession()
    {
        ...
        ASA = GetComponent<MeshRenderer>();
        ASA.material.color = new Color32(0, 255, 0, 255);
    }
    ...
    public async void CreateAzureAnchor(GameObject theObject)
    {
        ...
        //  オレンジ色にする
        ASA = GetComponent<MeshRenderer>();
        ASA.material.color = new Color32(255, 100, 0, 255);
        Debug.Log("1");
        // Notify AnchorFeedbackScript
        ...
        try
        {
            ...
            if (success)
            {
                ...
                //アンカーを赤色にする
                ASA = GetComponent<MeshRenderer>();
                ASA.material.color = new Color32(255, 0, 0, 255);
                // Notify AnchorFeedbackScript
        ...
        Debug.Log(currentAzureAnchorID);
    }
 ...
 Debug.Log("\nAnchorModuleScript.RemoveLocalAnchor()");
    ...
    public void FindAzureAnchor(string id = "")
    {
        ...
        //currentAzureAnchorID = "2bd2cc46-3ae0-47ec-98f9-da7e2c1f00e6";
       // currentAzureAnchorID = "83da1699-2d20-4e1a-ab39-769b662b1807";
       // currentAzureAnchorID = "a11a0781-e5bd-4cbc-b530-1c352ce9bfbd";
       // currentAzureAnchorID = "ce2e35f4-9c8a-4ead-bc6b-1821589d8ca1";
        currentAzureAnchorID = "41c32b0b-e456-49b8-9e85-dc1b62426f62";
        ...
        if ((cloudManager != null) && (cloudManager.Session != null))
        {
            ...
            //アンカーの色を黄色に変える
            ASA = GetComponent<MeshRenderer>();
            ASA.material.color = new Color32(255, 245, 0, 255);
